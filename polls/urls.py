...
urlpatterns = [
    ...
    path('correlation_matrix/<start_date>/<end_date>', views.correlation_matix, name='correlation_matrix'),
    path('correlation_matrix', views.correlation_matix, name='correlation_matrix'),
